...
An AI-powered application that analyzes multiple exam question papers and predicts the most frequently asked questions using **Sentence Transformers** and **Cosine Similarity**. Unlike traditional keyword matching, this project groups semantically similar questions to provide more meaningful predictions.
...
* Python
* Sentence Transformers (`# 📚 AI Exam Question Predictor
...
* 📄 Reads multiple PDF question papers
* 🔍 Extracts questions using Regular Expressions (Regex)
* 🔢 Supports question formats such as `1.`, `1)`, `Q1.`, and `Q1)`
* 🧹 Normalizes extracted questions before comparison
* 🧠 Converts questions into sentence embeddings using Sentence Transformers
* 📊 Compares semantic similarity with Cosine Similarity
* 📈 Groups semantically similar questions and counts their occurrences
* 📋 Displays the most frequently asked questions
...
│   └── 2019.pdf
│
├── app.py# 📚 AI Exam Question Predictor
